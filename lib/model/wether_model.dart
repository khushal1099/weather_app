...
//
//     final Wether = WetherFromJson(jsonString);

import 'dart:convert';

Wether WetherFromJson(String str) => Wether.fromJson(json.decode(str));

String WetherToJson(Wether data) => json.encode(data.toJson());
